...
public interface UsuarioControllerOpenApi {
	...
	UsuarioModel buscar(@ApiParam(value = "ID do usuário", required = true) Long usuarioId);
	...
	UsuarioModel atualizar(@ApiParam(value = "ID do usuário", required = true) Long usuarioId, UsuarioInput usuarioInput);
	...
	void alterarSenha(@ApiParam(value = "ID do usuário", required = true) Long usuarioId, SenhaInput senha);

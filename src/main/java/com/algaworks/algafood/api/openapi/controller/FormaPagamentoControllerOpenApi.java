...
public interface FormaPagamentoControllerOpenApi {
	...
	ResponseEntity<FormaPagamentoModel> buscar(@ApiParam(value = "ID de uma forma de pagamento", required = true) Long formaPagamentoId, ServletWebRequest request);
	...
	FormaPagamentoModel atualizar(@ApiParam(value = "ID de uma forma de pagamento", required = true) Long formaPagamentoId, FormaPagamentoInput formaPagamentoInput);
	...
	void remover(@ApiParam(value = "ID de uma forma de pagamento", required = true) Long formaPagamentoId);

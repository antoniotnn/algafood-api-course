...
public interface CidadeControllerV2OpenApi {
	...
	CidadeModelV2 buscar(@ApiParam(value = "ID de uma cidade", required = true) Long cidadeId);
	...
	CidadeModelV2 atualizar(@ApiParam(value = "ID de uma cidade", required = true) Long cidadeId, CidadeInputV2 cidadeInput);

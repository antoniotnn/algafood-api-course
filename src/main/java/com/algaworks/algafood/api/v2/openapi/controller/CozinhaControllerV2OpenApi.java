...
public interface CozinhaControllerV2OpenApi {
	...
	CozinhaModelV2 buscar(@ApiParam(value = "ID de uma cozinha", required = true) Long cozinhaId);
	...
	CozinhaModelV2 atualizar(@ApiParam(value = "ID de uma cozinha", required = true) Long cozinhaId, CozinhaInputV2 cozinhaInput);
